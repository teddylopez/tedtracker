...
describe 'navigate' do
  ...
  describe 'index' do
    ...
    it 'has a scope that is only visible to the user that submitted it' do
      ...
      post_from_other_user = Post.create(date: Date.today, description: "This post shouldn't be seen", user_id: other_user.id, daily_hours: 3.5)
  ...
  describe 'creation' do
    ...
    it 'can be created from new form page' do
      ...
      fill_in 'post[daily_hours]', with: 1.6
